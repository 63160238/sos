        ...
        <div class="card-body">
          <h6 class="card-subtitle">กรุณากรอกข้อมูลให้ครบถ้วน</h5>
            <div class="form-group" id="meter">
              ...
              <input type="text" class="form-control form-control-line" name="inputValue[]" value="<?= isset($getData) ? $getData->p_name : '' ?>" id="p_name" disabled required>
            </div>
            <div class="form-group">
              <label for="role">addr<span class="text-danger"> *</span></label>
              <input type="text" class="form-control form-control-line" name="inputValue[]" value="<?= isset($getData) ? $getData->addr : '' ?>" id="addr" disabled required>
            </div>
            <div class="form-group">
              <label for="role">emb_id<span class="text-danger"> *</span></label>
              <input type="text" class="form-control form-control-line" name="inputValue[]" value="<?= isset($getData) ? $getData->emb_id : '' ?>" id="emb_id" disabled required>
            </div>
            <div class="form-group" id="c_a">
              ...
              <select class="form-control" id="r_id" name="inputValue[]" disabled required>
                ...
                <?php foreach ($apartment_room as $key => $value) : ?>
                  <option value="<?= $value->r_id ?>" <?= isset($getData->p_id) && $getData->p_id == $value->r_p_id ? 'selected' : '' ?>>
                    <?= $value->r_name ?>
                  </option>
                <?php endforeach; ?>
              </select>
