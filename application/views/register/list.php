              ...
              <?php if (is_array($getData)) : ?>
                <?php foreach ($getData as $key => $value) : ?>
                  <tr>
                    ...
                    <button type="button" class="btn btn-info btn-sm" name="edit" id="get" onclick="view(<?= $value->user_id ?>)" title="ดูข้อมูลผู้เช่า"><i class="fas fa-eye"></i></button>
                    <button type="button" class="btn btn-warning btn-sm" name="edit" id="edit" onclick="edit(<?= $value->user_id ?>)" title="แก้ไขข้อมูลผู้เช่า"><i class="icon-pencil"></i></button>
