			...
			'<div class="modal fade" id="session-timeout-dialog">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						...
						'<button id="session-timeout-dialog-logout" type="button" class="btn btn-default">' + d.logoutButton + '</button>'+
						'<button id="session-timeout-dialog-keepalive" type="button" class="btn btn-primary" data-dismiss="modal">' + d.keepAliveButton + '</button>'+
						'</div>'+
					'</div>'+
				'</div>'+
			'</div>'), e("#session-timeout-dialog-logout").on("click", function() {
